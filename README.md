...
```kotlin
plugins {
    id("com.vk.vkompose") version "0.5.3"
}
```
...
```kotlin
plugins {
    id("com.vk.recompose-highlighter") version "0.5.3"
    id("com.vk.recompose-logger") version "0.5.3"
    id("com.vk.compose-test-tag-applier") version "0.5.3"
    id("com.vk.compose-test-tag-cleaner") version "0.5.3"
    id("com.vk.compose-test-tag-drawer") version "0.5.3"
    id("com.vk.compose-source-information-cleaner") version "0.5.3"
    id("com.vk.composable-skippability-checker") version "0.5.3"
}
...
```kotlin
dependencies {
    detektPlugins("com.vk.vkompose:detekt:0.5.3")
}
```
